...
#include <mcudrv/stm32/f4/dma/dma.h>
...
public:
    ...
    void init_injected_internal(InjectedChannelConfig channel_config);
    void init_regular_internal(RegularChannelConfig channel_config);
